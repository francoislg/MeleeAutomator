...
namespace MeleeAutomator {
    ...
    public class WindowCapture {
        ...
        public Bitmap CaptureWindow(IntPtr handle) {
            ...
            return CaptureRegion(handle, 0, 0, width, height);
        }

        public Bitmap CaptureRegion(IntPtr handle, Rectangle rect) {
            return CaptureRegion(handle, rect.Left, rect.Top, rect.Width, rect.Height);
        }
